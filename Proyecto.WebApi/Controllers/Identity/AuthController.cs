...
using Proyecto.Aplication.Dtos.Identity.User;
using Proyecto.Aplication.Dtos.Login;
using Proyecto.Entities.MicrosoftIdentity;
using Proyecto.Services.AuthServices;
using Proyecto.WebApi.Configurations;

namespace Proyecto.WebApi.Controllers.Identity
{
